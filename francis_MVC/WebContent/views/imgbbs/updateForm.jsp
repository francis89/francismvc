...
<%@ page import="model.imgbbs.*,utility.*" %>
<%@ taglib prefix="elfnc" uri="/ELFunctions" %>
...
<FORM name='frm' 
  ...
  <TABLE style="width: 45%;">
     <TR>
      <TD colspan="2">
      <img style="width:300px;height:200px;" src="${pageContext.request.contextPath }/views/imgbbs/storage/${dto.filename }">
      </TD>
      <td></td>
    </TR>
    <TR>
    ...
    <TR>
      <TH>사진파일</TH>
      <TD><input type="file" name="filename" size="40">${elfnc:checkNull(dto.filename) }</TD>
    </TR>
    <TR>
      <TH>내용</TH>
      <TD>
