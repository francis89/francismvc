...
<td>성별</td>
<td><label for="g1">
<input id = "g1" type="radio" name="gender" value="남"> 남자 </label>
<label for="g2">
<input id = "g2" type="radio" name="gender" value="여"> 여자 </label></td>
</tr>
<tr>
<td> 전화번호 </td>
...
<label for="s5"><input id="s5" type="checkbox" name="skill" value="jQuery"> jQuery</label>
</td>
</tr>
<tr>
<td> 취미 </td>
