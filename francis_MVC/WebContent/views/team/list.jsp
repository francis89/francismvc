		...
		<c:forEach items="${list}" var="dto">
			<tr>
     		 <td>${dto.no }</td>
      		 ...
      		 <td>${dto.phone }</td>
      	 	 <td>${dto.skillstr }</td>
       	  	 <td><img src='${pageContext.request.contextPath }/views/team/storage/${dto.filename }'></td>
      		 <td>
...
<DIV class='bottom'>
    ${paging }
	<input type="button" value="등록" onclick="location.href='${pageContext.request.contextPath }/team/create.do'">
  </DIV>
</body> 
</html> 
