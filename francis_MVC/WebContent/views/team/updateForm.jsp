...
<table>
	<tr>
		...
		<img src='${pageContext.request.contextPath }/views/team/storage/${dto.filename}' style='width: 500px; height: 450px;'>
		</th>
	</tr>
	<tr>
		<td> 이름 </td>
	...
	<tr>
		...
		<td>
			...
			<c:if test="${fn:indexOf(skill,'java')!= -1 }">checked</c:if>> Java </label>
			<label for="s2"><input id="s2" type="checkbox" name="skill" value="Jsp"
			<c:if test="${fn:indexOf(skill,'Jsp')!= -1 }">checked</c:if>> Jsp </label>
			<label for="s3"><input id="s3" type="checkbox" name="skill" value="MVC"
			<c:if test="${fn:indexOf(skill,'MVC')!= -1 }">checked</c:if>> MVC </label>
			<label for="s4"><input id="s4" type="checkbox" name="skill" value="Spring"
			<c:if test="${fn:indexOf(skill,'Spring')!= -1 }">checked</c:if>> Spring </label>
			<label for="s5"><input id="s5" type="checkbox" name="skill" value="jQuery"
			<c:if test="${fn:indexOf(skill,'jQuery')!= -1 }">checked</c:if>> jQuery </label>
