...
<%@ page import="java.util.*,model.member.*,utility.*" %>
...
function read(id){
	var url ="${pageContext.request.contextPath }/member/read.do";
	url += "?id="+id;
	url += "&col=${col}";
	url += "&word=${word}";
	url += "&nowPage=${nowPage}";
...
<c:forEach items="${list}" var="dto">
  <TABLE style="width:80%;">
    <TR>
      ...
      <img src='${pageContext.request.contextPath }/views/member/storage/${dto.fname }' style="width:250px; height:200px;">
      </TD>
      <TH width="20%">I D</TH>
      <TD width="50%">
