...
function emailCheck(email){
	if(email==""){
		...
		document.frm.email.focus();
			...
			var url = "${pageContext.request.contextPath}/member/email_proc.do"
			url += "?email="+email;
...
<FORM name='frm' 
  ...
  <TABLE style="width:50%">
	<TR>
      ...
      <img src="${pageContext.request.contextPath}/views/member/storage/${dto.fname}" >
      </TD>
    </TR>    
	<TR>
      <TH>I D</TH>
    ...
    <TR>
      <TH>*E-mail</TH>
      <TD>
      <input type="text" name="email" size="25" onkeydown="emailCheck2(this)" value="${dto.email }" > 
